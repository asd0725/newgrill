...
export abstract class cShape {
    ...
    rotateAABB(world: cc.Mat3) {
        ...
        const m = world.m;
        const uX = m[0], uY = m[1], uZ = m[2];
        const vX = m[3], vY = m[4], vZ = m[5];
        const wX = m[6], wY = m[7], wZ = m[8];
    ...
    updateAABB(world: cc.Mat3, isIdentity: boolean = true) {
